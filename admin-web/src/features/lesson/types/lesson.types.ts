...
export enum LessonAssetType { Image = 0, Audio = 1, Document = 2 }
...
export interface AttachLessonVocabularyRequest { vocabularyId: number; sortOrder: number; isRequired: boolean; }
export interface UpdateLessonVocabularyRequest { sortOrder: number; isRequired: boolean; }
...
export interface AddLessonPrerequisiteRequest { requiredLessonId: number; }
