...
export const quizApi = {
  ...
  listQuestionOptions(quizId: number, questionId: number) {
    return apiClient<AdminQuizQuestionOption[]>(`${ROOT}/${quizId}/questions/${questionId}/options`);
  },

  createQuestionOption(quizId: number, questionId: number, request: QuizQuestionOptionRequest) {
    return apiClient<AdminQuizQuestionOption>(`${ROOT}/${quizId}/questions/${questionId}/options`, { method: "POST", body: request });
  },

  updateQuestionOption(quizId: number, questionId: number, optionId: number, request: QuizQuestionOptionRequest) {
    return apiClient<AdminQuizQuestionOption>(`${ROOT}/${quizId}/questions/${questionId}/options/${optionId}`, { method: "PUT", body: request });
  },

  deleteQuestionOption(quizId: number, questionId: number, optionId: number) {
    return apiClient<void>(`${ROOT}/${quizId}/questions/${questionId}/options/${optionId}`, { method: "DELETE" });
  },

  listMatchingPairs(quizId: number, questionId: number) {
    return apiClient<AdminQuizMatchingPair[]>(`${ROOT}/${quizId}/questions/${questionId}/matching-pairs`);
  },

  createMatchingPair(quizId: number, questionId: number, request: QuizMatchingPairRequest) {
    return apiClient<AdminQuizMatchingPair>(`${ROOT}/${quizId}/questions/${questionId}/matching-pairs`, { method: "POST", body: request });
  },

  updateMatchingPair(quizId: number, questionId: number, pairId: number, request: QuizMatchingPairRequest) {
    return apiClient<AdminQuizMatchingPair>(`${ROOT}/${quizId}/questions/${questionId}/matching-pairs/${pairId}`, { method: "PUT", body: request });
  },

  deleteMatchingPair(quizId: number, questionId: number, pairId: number) {
    return apiClient<void>(`${ROOT}/${quizId}/questions/${questionId}/matching-pairs/${pairId}`, { method: "DELETE" });
  },

  listTags() {
    return apiClient<AdminQuizTag[]>(TAG_ROOT);
  },

  createTag(request: QuizTagRequest) {
    return apiClient<AdminQuizTag>(TAG_ROOT, { method: "POST", body: request });
  },

  updateTag(id: number, request: QuizTagRequest) {
    return apiClient<AdminQuizTag>(`${TAG_ROOT}/${id}`, { method: "PUT", body: request });
  },

  activateTag(id: number) {
    return apiClient<void>(`${TAG_ROOT}/${id}/activate`, { method: "POST" });
  },

  deactivateTag(id: number) {
    return apiClient<void>(`${TAG_ROOT}/${id}/deactivate`, { method: "POST" });
  },

  deleteTag(id: number) {
    return apiClient<void>(`${TAG_ROOT}/${id}`, { method: "DELETE" });
  },

  attachTag(quizId: number, questionId: number, tagId: number) {
    return apiClient<void>(`${ROOT}/${quizId}/questions/${questionId}/tags/${tagId}`, { method: "POST" });
  },

  detachTag(quizId: number, questionId: number, tagId: number) {
    return apiClient<void>(`${ROOT}/${quizId}/questions/${questionId}/tags/${tagId}`, { method: "DELETE" });
  },
