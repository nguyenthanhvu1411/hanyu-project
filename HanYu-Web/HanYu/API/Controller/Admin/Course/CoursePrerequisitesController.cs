...
[Route("api/v1/admin/courses/{courseId:long}/prerequisites")]
public sealed class CoursePrerequisitesController : ControllerBase
{
    ...
    public CoursePrerequisitesController(IAdminCourseService service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetAll(
        ...
        => this.ToActionResult(await _service.GetPrerequisitesAsync(courseId, includeDeleted, cancellationToken));
    ...
    public async Task<IActionResult> Get(
        ...
        long prerequisiteId,
        CancellationToken cancellationToken)
        => this.ToActionResult(await _service.GetPrerequisiteAsync(courseId, prerequisiteId, cancellationToken));
    ...
    public async Task<IActionResult> Create(
        ...
        CancellationToken cancellationToken)
        => this.ToActionResult(await _service.CreatePrerequisiteAsync(courseId, request, cancellationToken));
    ...
    public async Task<IActionResult> Update(
        ...
        CancellationToken cancellationToken)
        => this.ToActionResult(await _service.UpdatePrerequisiteAsync(courseId, prerequisiteId, request, cancellationToken));
    ...
    public async Task<IActionResult> Delete(
        ...
        CancellationToken cancellationToken)
        => this.ToActionResult(await _service.DeletePrerequisiteAsync(courseId, prerequisiteId, request, cancellationToken));
    ...
    public async Task<IActionResult> Restore(
        ...
        CourseEntityWorkflowRequest request,
        CancellationToken cancellationToken)
        => this.ToActionResult(await _service.RestorePrerequisiteAsync(courseId, prerequisiteId, request, cancellationToken));
}
